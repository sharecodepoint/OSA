                            ...
                            <div className="col-lg-9">
                                <div className="single-page pr-30">
                                    ...
                                    <div className="single-content">
                                        <h4>Welcome to CoderXpoint’s Privacy Policy</h4>
                                        <ol start="1">
                                            <li>
                                                Hi there, we’re CoderXpoint Pty Ltd (ABN 11 119 159 741) of Level 1, 121 King Street Melbourne, 3000, Australia (“
                                                <strong>CoderXpoint</strong>”) and welcome to our privacy policy which also applies to our Affiliate Companies. This policy sets out how we handle your personal information if you’re an CoderXpoint user or visitor to our Sites. It applies across CoderXpoint Elements, CoderXpoint Market, CoderXpoint Twenty20, CoderXpoint Studio, CoderXpoint Sites, CoderXpoint Tuts+ and Placeit (the “<strong>Sites</strong>”).
                                            </li>
                                            <li>When we say ‘we’, ‘us’ or ‘CoderXpoint’ it’s because that’s who we are and we own and run the Sites.</li>
                                        ...
                                        <ol start="6">
                                            ...
                                            <li>
                                                As the operator of digital content marketplaces, we have a legitimate interest in verifying the identity of our authors. We believe that knowing who our authors are will strengthen the integrity of our marketplaces by reducing fraud, making authors more accountable for their content and giving CoderXpoint and customers the ability to enforce contracts for authors who break the rules. CoderXpoint also has certain legal obligations that require us to know who our authors are in certain circumstances. In light of this, if you are an author we will verify your identity, in particular, your name, full address and date of birth by asking you to show us a Photo ID document. The verification procedure is called CoderXpoint Verify. CoderXpoint Verify will be carried out by
                                                our service provider Jumio Corporation located at 395 Page Mill Road, Suite 150, Palo Alto, California, USA. As part of CoderXpoint Verify, you will be asked to take a selfie which will then be compared against your Photo ID document using facial recognition technology. We will use your Photo ID document solely to carry out CoderXpoint Verify and delete it after the completion of this process.
                                            </li>
                                        </ol>
                                                ...
                                                <ol>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ol>
                                                            ...
                                                            <li>training CoderXpoint staff about how to best serve our user community;</li>
                                                            ...
                                                            <li>processing your job application to CoderXpoint.</li>
                                                        </ol>
                                                    </li>
                                                    <li>
                                        ...
                                        <ol start="11">
                                            <li>
                                                ...
                                                <ol>
                                                    <li>companies that are in the CoderXpoint group which are located in Australia, Mexico and the US;</li>
                                        ...
                                        <ol start="17">
                                            <li>
                                                ...
                                                <a href="https://CoderXpoint.com/cookies/">here</a>
                                            ...
                                            <li>
                                                ...
                                                <a href="https://CoderXpoint.com/cookies/">cookie policy</a>.
                                            </li>
                                        </ol>
                                        ...
                                        <ol start="22">
                                            <li>
                                                We retain your personal information for as long as is necessary to provide the services to you and others, and to comply with our legal obligations. If you no longer want us to use your personal information or to provide you with the CoderXpoint services, you can request that we erase your personal information and close your CoderXpoint account. Please note that if you request the erasure of your personal information we will retain information from deleted accounts as necessary for our legitimate business interests, to comply with the law, prevent fraud, collect fees, resolve disputes, troubleshoot problems, assist with investigations or requests by government, a court of law, or law enforcement authorities, enforce the terms of service and take other
                                                actions permitted by law. The information we retain will be handled in accordance with this Privacy Policy.
                                            </li>
                                        </ol>
                                        ...
                                        <ol start="25">
                                            <li>
                                                ...
                                                <a href="mailto:privacy.champion@CoderXpoint.com">privacy.champion@CoderXpoint.com</a>.
                                            </li>
                                        ...
                                        <ol start="1">
                                            <li>
                                                For the purposes of applicable EU data protection law (including the General Data Protection Regulation 2016/679 (the “<strong>GDPR</strong>”), we are a ‘data controller’ of your personal information.
                                            </li>
                                        </ol>
                                        <h4>How you can access your personal information</h4>
                                        <ol start="2">
